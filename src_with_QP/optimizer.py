...
import copy
def evaluate(num_of_patients, relocation_count=1, qa_trial_count=1, width = 86000, height = 86000, num_of_fire_departments = 8, num_of_rendezvous_points = 10, num_of_basehospitals = 8, use_d_wave=True, is_new_algorithm_p1 = False, is_new_algorithm_p2 = False, is_QP = True):
  ...
  for j in range(relocation_count):
    ...
    if is_QP:
      ...
      qp = QP()
      best_classic = copy.deepcopy(qp)
      classic_total_score = world_classic.getTotalScore(qp)
...
def grid_search(num_of_patients, relocation_count=1, qa_trial_count=1, width = 86000, height = 86000, num_of_fire_departments = 8, num_of_rendezvous_points = 10, num_of_basehospitals = 8, use_d_wave=True, is_new_algorithm_p1 = False, is_new_algorithm_p2 = False, is_QP = True):
